...
public class Boligsøker extends Person implements Serializable
{
    ...
    // datafelt for krav
    int by, rom, minPris, maxPris, parkering, antEtasjer, kjeller, minTomt,
        maxTomt, heis, balkong, delerBadMed, delerKjøkkenMed;


    public Boligsøker (){}

    public Boligsøker(String n, String a, String t, String e, int b, int r, int
                  ...
                  int blkng, int dbm, int dkm )
    {
        ...
        // krav
        by = b; rom = r; minPris = mip; maxPris = map; parkering = p; antEtasjer = ae;
   ...
   public int[] getKrav()
   {
       Krav[0] = by;        Krav[1] = rom;         Krav[2] = minPris;  Krav[3] = maxPris;
       Krav[4] = parkering; Krav[5] = antEtasjer;  Krav[6] = kjeller;  Krav[7] = minTomt;
       Krav[8] = maxTomt;   Krav[9] = heis;        Krav[10] = balkong; Krav[11] = delerBadMed;
       Krav[12] = delerKjøkkenMed;
